...
class MaintenanceTab(QWidget):
    ...
    def _init_ui(self):
        ...
        note = QLabel(
            ...
            "Your shots are preserved - only new features are added."
        )
    ...
    def _create_status_section(self):
        ...
        info_text = (
            ...
            f"<b>Shots:</b> {stats['shot_count']}  |  "
            f"<b>Playblasts:</b> {stats['playblast_count']}  |  "
            f"<b>Reviews:</b> {stats['review_count']}"
        )
    ...
    def _create_maintenance_section(self):
        ...
        rebuild_desc = QLabel("Clear database and reimport all shots from files")
    ...
    def _on_upgrade_clicked(self):
        ...
        reply = QMessageBox.question(
            ...
            f"Your existing shots will be preserved.",
    ...
    def _on_rebuild_database(self):
        ...
        reply = QMessageBox.warning(
            ...
            "2. Clear all shots from the database\n"
            "3. Reimport all shots from project files\n\n"
            "Use this if shots are missing or out of sync.\n\n"
            "Continue?",
            QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No
        )
        ...
        try:
            ...
            # Clear all shots
            cleared = self._db_service.clear_all_shots()
            ...
            QMessageBox.information(
                ...
                f"Found: {total_found} shot folders\n"
                f"Imported: {newly_imported} shots\n\n"
